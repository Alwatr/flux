...
> ---
>
> **اطلاعیه مهاجرت و بازنویسی مخزن**
>
> بسته flux منسوخ شده و برای ماژولاریتی و عملکرد بهتر، به دو بسته تخصصی در مونو-ریپوی Alwatr تقسیم شده است:
>
> ۱. **[@alwatr/signal](https://github.com/Alwatr/alwatr/tree/next/pkg/signal)**: برای مدیریت وضعیت واکنش‌گرا و سیگنالینگ رویدادها.
> ۲. **[@alwatr/fsm](https://github.com/Alwatr/alwatr/tree/next/pkg/fsm)**: یک پیاده‌سازی اختصاصی و سبک از ماشین حالت متناهی (FSM).
>
> لطفاً وابستگی‌های خود را به این بسته‌های جدید منتقل کنید. این مخزن اکنون آرشیو شده است.
